...
function Grid2Pos(x, y)
    ...
    -- print('visibleSize.width...', visibleSize.width)
    -- print('visibleSize.height...', visibleSize.height)

    -- print('PosOffsetX...', PosOffsetX)
    -- print('PosOffsetY...', PosOffsetY)
...
function Pos2Grid(posx, posy)
    ...
    return GetIndex(x + 0.5), GetIndex(y + 0.5)
end
...
function RectIntersect(r1, r2)
    ...
    if r2:width() == 2 or r2:height() == 0 then
        return r1
    end
